...
if __name__ == '__main__':
    ...
    # 2. 
    grouped = data_.groupby(['country','application_span'])
    # Grouped()
    temp = grouped['country'].count().unstack()
    
    
    #%% 3. Textmining & LDA preparation 
    ...
    transformer = MinMaxScaler() #최대최소를 0-1로바꾸어서 두개의다른 지표를 같이 비교
...
#%%
    ...
    topic_time_topn_df.index = ['`01-`05', '`06-`10' , '`11-`15', '`16-`20', '111']
    ...
    temp.columns = ['`01-`05', '`06-`10' , '`11-`15', '`16-`20', '111']
